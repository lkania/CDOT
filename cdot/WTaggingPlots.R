...
load("./cdot/WTaggingDecorrelated.RData")
...
# Saving the plots
ggsave(plot.mass,
       filename = paste0("./cdot/img/PlotMass.png"),
       width = 6, height = 3.5)

ggsave(plot.masscut,
       filename = paste0("./cdot/img/PlotMassCut.png"),
       width = 6, height = 3.5)

ggsave(plot.masscutCDOT,
       filename = paste0("./cdot/img/PlotMassCutCDOT.png"),
       width = 6, height = 4)
...
ggsave(ggarrange(plot[[1]], plot[[2]], plot[[3]], plot[[4]],
       ...
       filename = paste0("./cdot/img/WTaggingNoDecorrelation.pdf"),
       width = 12, height = 3.3)
...
ggsave(ggarrange(plot1[[1]], plot1[[2]], plot1[[3]], plot1[[4]],
       ...
       filename = paste0("./cdot/img/WTaggingWithDecorrelation.png"),
       width = 12, height = 6.5)
