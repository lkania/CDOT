...
ggsave("3b-histograms.pdf", pp, scale=1)
...
pp.3b <- ggplot(aes(x = value), data=mpgstack) + 
  ...
  facet_wrap(~variable, scales="free")
# pp + stat_bin(geom="text", aes(label=..count.., vjust=-1))
ggsave("4b-histograms.pdf", pp, scale=1)
...
pp.3b <- ggplot(aes(x = value), data=mpgstack) + 
  ...
  facet_wrap(~variable, scales="free")
# pp + stat_bin(geom="text", aes(label=..count.., vjust=-1))
ggsave("Signal-histograms.pdf", pp, scale=1)
...
ggsave(ggarrange(plot4b[[1]], plot4b[[2]], plot4b[[3]], plot4b[[4]], 
       ...
       filename = paste0("3b4bWithDecorrelation.png"),
       width = 12, height = 6)
...
ggsave(ggarrange(plot4b[[1]], plot4b[[2]], plot4b[[3]], plot4b[[4]], 
       ...
       filename = paste0("4bNoDecorrelation.pdf"),
       width = 12, height = 3)
...
ggsave(grid.arrange(plot_test[[1]], plot_test[[2]], plot_test[[3]], 
                    ...
                    nrow = 2), 
       filename = paste0("Test3bCDOT.png"),
       width = 16, height = 8)
...
ggsave(grid.arrange(plot_test[[1]], plot_test[[2]], plot_test[[3]], 
                    ...
                    plot_test[[7]], plot_test[[8]], plot_test[[9]],
                    nrow = 2), 
       filename = paste0("Test3bcorr.png"),
       width = 16, height = 8)
...
ggsave(grid.arrange(plot_test[[1]], plot_test[[2]], plot_test[[3]], 
                    ...
                    plot_test[[7]], plot_test[[8]], plot_test[[9]],
                    nrow = 2), 
       filename = paste0("Test4bcorr.png"),
       width = 16, height = 8)
...
ggsave(grid.arrange(plot_test[[1]], plot_test[[2]], plot_test[[3]], 
                    ...
                    plot_test[[7]], plot_test[[8]], plot_test[[9]],
                    nrow = 2), 
       filename = paste0("Test4bCDOTEnriched.png"),
       width = 16, height = 8)
...
ggsave(grid.arrange(plot_test[[1]], plot_test[[2]], plot_test[[3]], 
                    ...
                    plot_test[[7]], plot_test[[8]], plot_test[[9]],
                    nrow = 2), 
       filename = paste0("Test4bcorrEnriched.png"),
       width = 16, height = 8)
