...
background_3b = h5read(paste0("bbbj", ".h5"), "/df/block0_values")
background_3b = as.data.frame(t(background_3b))
cols_3b = h5read(paste0("bbbj", ".h5"), "/df/block0_items")
colnames(background_3b) = cols_3b

# Loading signal
load("Signal400.RData")
signal = Signal400
rm("Signal400")
...
save(combdata, file = "Data3b4b.RData")
